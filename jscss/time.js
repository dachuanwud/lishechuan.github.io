function showTime() { 
	...
	var startDate = new Date(2018, 3, 29);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear Tian:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----dachuanwudi   2018-03-29</c>"; 
